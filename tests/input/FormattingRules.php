...
class FormattingRules extends Foo
{
    ...
    private const CONST_F = 6, CONST_G = 7;
    private $foo;
    /**
     * @var mixed
     */
    ...
    public function singlelineMethod(
        string $foo,
        int $bar
    ): void {
    ...
    public function multilineMethod(string $firstArgument, string $secondArgument, DateTimeImmutable $thirdArgument): void
    {
        $this->singlelineMethod('Lorem ipsum dolor sit amet, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 42);
